export default function AlertRowModal({
	callback
}: {
							...
							<div className='sm:flex sm:items-start'>
								...
								<div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
									<h3
										...
										id='modal-title'
									>
										Continuare con il Semi Lavorato
									</h3>
									<div className='mt-2'>
										<p className='text-sm text-gray-500'>
											Risulta un ordine aperto già preso in
											carico, annullare la lavorazione
											dell'Ordine aperto per continuare con
											la preparazione del Semi Lavorato?
										</p>
									</div>
								</div>
							</div>
